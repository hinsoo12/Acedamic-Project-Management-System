	...
	<section >
				<form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
					 ...
					 <div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Input Full Name</label>
									<div class="col-lg-3">
                                      <input type="text" name="name" class="form-control">
                                    </div>
                                </div>
                    <div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Input you UID</label>
									<div class="col-lg-3">
				...
				$end=$_POST["grade"];
				$last=$_POST["name"];
			$ch =mysqli_query($conn, "select * from studgrad where stud_id = '$_POST[grade]'");
                                          ...
                                          ?> 	<div class="form-group row">
									<label for="fname" class="col-sm-3 text-right control-label col-form-label">Your Grade IS</label>
									<div class="col-lg-3">
