                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                <center>
                                    ...
                                    $procd = "PRJ".rand();
                                    mysqli_query($conn, "insert into approvedttl values ('','$did','$procd','$_POST[fprottl]','$_POST[fprottdisc]','$_POST[scp]','$fprojprpsl','$_POST[advstffid]','$_POST[exmcd]','Approved')");
                           ...
                           <strong style="color: black">Your Group Title Is Successfully Approved  Project Code is <?php echo $procd; ?></strong>
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">First Project Programming Language</label>
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control"name="fprottl" value="<?php echo $fprottl; ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" name="lang" class="form-control" value="<?php echo $fprojlang; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                               ...
                               <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Second Project Programming Language</label>
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control"name="fprottl" value="<?php echo $fprottl; ?>" readonly>
                                        </div>
                                    </div>
