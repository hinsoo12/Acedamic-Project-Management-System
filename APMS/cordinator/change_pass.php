...
<?php
			...
			if (isset($_POST['submit_form'])){	
                        ...
                        $run = mysqli_query($conn,"select * from user where username='$_SESSION[username]'");
						...
						{
							mysqli_query($conn, "update user set password = '$encpass' where username='$_SESSION[username]'");
	...
	<form id="formID"  name="formID"  method="post" action="<?php $_PHP_SELF?>"  onsubmit="return validateForm()">
						...
						<div class="form-group row">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                   ...
                                   <div>
                                   	<label for="fname" class="col-sm-3 text-right control-label col-form-label">Confirm Pass</label>
                                   </div>
                                   <div class="col-lg-7">
				...
				<div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="Submit" name="submit_form" class="form-control btn-success" value="Submit">
                                        </div>
                                    </div>
		</form>
		</div>
