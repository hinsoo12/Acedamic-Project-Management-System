                            ...
                            <div class="card-body">
                               ...
                               <form method="post" action="">
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                        <select name="advstffid" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                ...
                                mysqli_query($conn, "insert into examiners values ('','$_POST[advstffid]', '$addfirstnm','$addmiddlnm','$addlastnm','$usernem','$fpass','examiners','$addemail', 'activated', '$depp','$regdt', '$num')");
                                 $coregdt = date("Y-m-d"); 
