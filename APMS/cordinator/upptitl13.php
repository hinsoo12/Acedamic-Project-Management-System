...
$did = $_GET["uid"];
                                    $ch =mysqli_query($conn, "select * from title where group_uid = '$did'");
                                            while ($rowww = mysqli_fetch_array($ch)) {
                                                ...
                                                $fprottl = $rowww["thirdprotitl"];
                                                $fprodisc = $rowww["thirdprodiscrip"];
                                                $fprojprop = $rowww["thirdprojprop"];
                                                $tprojlang = $rowww["third_lang"];
}
                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                <center>
                                    ...
                                    $procd = "PRJ".rand();
                                    mysqli_query($conn, "insert into approvedttl values ('','$did','$procd','$_POST[fprottl]','$_POST[lang]','$_POST[fprottdisc]','$_POST[scp]','$_POST[fprojprpsl]','$_POST[advstffid]','$_POST[exmcd]','Approved')");
                           ...
                           <strong style="color: black">Your Group Title Is Successfully Approved  Project Code is <?php echo $procd; ?></strong>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" name="lang" class="form-control" value="<?php echo $tprojlang; ?>" readonly>
                                        </div>
                                    </div>
