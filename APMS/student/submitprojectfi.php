                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                                <center>
                                    <div class="card-body"><h4>Submit Your Project The End One</h4>
...
if (isset($_POST["subprog"])) {
 $tm=md5(time());
   ...
   $dt = date("Y-m-y");                 
mysqli_query($conn, "insert into project values('', '$groipid', '$_SESSION[username]', '$adcode', '$procd', '$_POST[prottl]', '$dst2', '$dt', 'notseen')");
?>
