                            ...
                            <div class="card-body">
                               ...
                               <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" name="stud1fullname" class="form-control" value="<?php echo $std1fullname; ?>" readonly>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" name="stud1id" class="form-control" value="<?php echo $std1id; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" data-parsley-max="10" name="dcupma1" required="" class="form-control" >
                                    </div>
                                </div>
                                 <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" data-parsley-max="5" name="atten1" required="" class="form-control" >
                                    </div>
                                </div>
                                 <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" data-parsley-max="15" name="under1" required="" class="form-control" >
                                    </div>
                                </div>
                                    <div class="form-group row">
                                ...
                                <div class="table-responsive">
                                   ...
                                   $sql= mysqli_query($conn, "select * from studgrad where fullname = '$std1fullname'");
