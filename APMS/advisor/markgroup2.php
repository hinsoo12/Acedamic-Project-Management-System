...
?>
                            ...
                            <div class="card-body">
                              ...
                              <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" name="stud1fullname" class="form-control" value="<?php echo $std2fullname; ?>">
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" name="stud1id" class="form-control" value="<?php echo $std2id; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
   ...
   $dt = date("Y-m-y");
                                ...
                                <div class="table-responsive">
                                   ...
                                   $sql= mysqli_query($conn, "select * from studgrad where fullname = '$std2fullname'");
