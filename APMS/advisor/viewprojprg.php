                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                             $ch =mysqli_query($conn, "select * from projectprogress where advisorcode = '$advcd' and status = 'notseen'");
                                            while ($rowww = mysqli_fetch_array($ch)) {
                                                $id = $rowww["id"];
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="returnprog.php?id=<?php echo $id; ?>"><button class="btn btn-success">Send Commented Doc</button></a>
                                                </td>
