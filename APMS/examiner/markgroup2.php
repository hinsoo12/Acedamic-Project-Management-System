...
?>
                            ...
                            <div class="card-body">
                                <?php
                                 $ch =mysqli_query($conn, "select * from advosorandco where username = '$_SESSION[username]'");
                                            ...
                                            $ch =mysqli_query($conn, "select * from studgrad where groupuid = '$id'");
                                            while ($rowww = mysqli_fetch_array($ch)) {
                                                $idd = $rowww["id"];
                                                $fullname2 = $rowww["fullname"];
                                                $studid2 = $rowww["stud_id"];
                               ...
                               <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="validationform" data-parsley-validate="" novalidate="">
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" name="stud1fullname" class="form-control" value="<?php echo $fullname2; ?>">
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-lg-7">
                                       <input type="text" name="stud1id" class="form-control" value="<?php echo $studid2; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
   ...
   $dt = date("Y-m-y");
                                mysqli_query($conn, "update studgrad set documentation = '$_POST[dcupma1]', answering= '$_POST[atten1]', confidence = '$_POST[under1]', total = '$total' where id = '$idd'");
                                  ?>
