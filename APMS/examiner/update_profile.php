...
<div class="container-fluid">
      ...
      mysqli_query($conn, "update examiners set username='$_POST[username2]',email_address='$_POST[email_address2]' where username = '$_SESSION[username]'");
       ?>
       <script type="text/javascript">
        ...
        window.location = "examinerpage.php";
       </script>
       <?php
      }
